<template>
  <el-card id="el_card">
    <el-row>
        <el-page-header :content="head" v-if='head' @back="goBack" style="margin:10px 0 30px 0">
        </el-page-header>
        <el-tabs type="border-card"  @tab-click="handleClick" :style="{width:type? '20.3%' : '100%'}">
          ...
          <el-button type="primary" @click="add">新增POS收款</el-button>
        </el-col>
    </el-row>
    <el-row v-if="!type" :style="{width:type? '20.3%' : '100%'}">
        <el-col>
          <el-table :data="tableData" border style="width: 100%">
            ...
            <el-table-column prop="title" label="编码" width="200"></el-table-column>
            <el-table-column prop="serial_number" label="排序" width="250"></el-table-column>
    ...
    <el-dialog :title="title" :visible="dialogVisible" width="30%" :show-close="false">
      ...
      >
        ...
        <el-form-item label="状态" prop="value1">
          <el-switch v-model="ruleForm.value1" active-color="#008080"  active-text="是"
  inactive-text="否" inactive-color="#ff4949"></el-switch>
        </el-form-item>
         <el-form-item label="明交输入金额" prop="value2">
          <el-switch v-model="ruleForm.value2" active-color="#008080"  active-text="是"
  inactive-text="否" inactive-color="#ff4949"></el-switch>
        </el-form-item>
    ...
    <el-dialog :title="title" :visible="dialogVisible_" width="40%" :show-close="false">
      ...
      >
        ...
        <el-form-item label="状态" prop="value1">
          <el-switch v-model="ruleForm_.value1" active-color="#008080"  active-text=启用
  inactive-text="关闭" inactive-color="#ff4949"></el-switch>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [
          { required: true, message: "请填写POS编码", trigger: "blur" },
        ],
        sort:[
