...
export default {
    ...
    methods:{
           async activeList() {
            ...
            add(){
                this.$router.push('./miniprogramDiscountEdit')
            },
            edit(i,el){
                this.$router.push({path:"./miniprogramDiscountEdit",query:{id:el.id}})
            },
            shop_list(i,el){
                this.$router.push({path:"./miniprogramDiscountShopList",query:{id:el.id}})
            },
            del(i,el){
               this.$api
