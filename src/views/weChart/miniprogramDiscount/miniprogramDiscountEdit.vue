        ...
        <el-col >
            <el-form :model="ruleForm"  ref="ruleForm" label-width="200px" class="demo-ruleForm">
                ...
                <el-form-item label="商品限购：" prop="limit_state">
                    ...
                    <div class="red">限购仅允许购买3件限时折扣商品</div>
                </el-form-item>
                <el-form-item label="限购件数"   prop="limit_sale" v-if='ruleForm.limit_state == 1'  style="width:500px">
                    <el-input v-model="ruleForm.limit_sale"></el-input>
                </el-form-item>
...
export default {
    ...
    methods:{
        ...
        limitStoreDetail(){
            this.$api
            .limitStoreDetail({sale_id:this.$route.query.id })
            .then(res => {
            if (res.data.code == 200) {
            ...
            if (valid) {
              ...
              if(id){
                //  修改
                  ...
                  .then(res=>{
                      res.data.code == 200 ? ( this.$message.success(res.data.msg),( this.$router.push("./miniprogramDiscount"))):(this.$api.error(res.data.msg))
                  })
                  .catch(res => {
                  this.$api.error();
                  });
                    ...
                    // 新增  
                    this.$api.limitStoreAdd(this.ruleForm)
                    .then(res=>{
                      res.data.code == 200 ? ( this.$message.success(res.data.msg),( this.$router.push("./miniprogramDiscount"))):(this.$api.error(res.data.msg))
                    })
                    .catch(res => {
      ...
      resetForm(formName) {
        this.$router.push("./miniprogramDiscount")
      },
    //  移除商品
    del(index, data) {
